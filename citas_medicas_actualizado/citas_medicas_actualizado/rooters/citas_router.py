...
@router.post("/", summary="Agendar Cita", dependencies=[Depends(get_current_user(["Paciente"]))])
...
@router.get("/paciente/{paciente_id}", summary="Listar Citas", dependencies=[Depends(get_current_user(["Paciente", "Administrador"]))])
...
@router.get("/{cita_id}", summary="Ver Cita por ID", dependencies=[Depends(get_current_user(["Paciente", "Administrador", "Médico"]))])
...
@router.delete("/{cita_id}", summary="Cancelar Cita", dependencies=[Depends(get_current_user(["Paciente", "Administrador"]))])
...
@router.put("/{cita_id}", summary="Actualizar Cita", dependencies=[Depends(get_current_user(["Paciente", "Administrador"]))])
